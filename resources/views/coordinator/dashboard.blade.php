<x-app-layout>
    ...
    <!-- Section 1: Proposals Awaiting Endorsement -->
    ...
    <!-- Section 2: Proposals Noted by Dean -->
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        <div class="card-header bg-white border-bottom-0 pt-4 pb-3 px-4">
            <h5 class="mb-0 fw-bold text-success">Proposals Noted by Dean</h5>
            <small class="text-muted">These endorsements are ready to be submitted to the Research Unit.</small>
        </div>
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="bg-light">
                ...
                <tbody>
                        ...
                        <td class="pe-4 text-end py-4">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <form action="{{ route('coordinator.proposals.submitToUnit', $proposal->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    <button type="submit" class="btn btn-primary btn-sm px-4 py-2 d-inline-flex align-items-center gap-2 rounded-pill fw-bold shadow-sm" onclick="return confirm('Are you sure you want to submit this endorsement list to the Research Unit?');">
                                        <i class="bi bi-send fs-6"></i> Submit to Research Unit
                                    </button>
                                </form>
                            </div>
                        </td>
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="text-center py-5 text-muted small italic">No Dean-noted proposals awaiting submission to the Research Unit.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
